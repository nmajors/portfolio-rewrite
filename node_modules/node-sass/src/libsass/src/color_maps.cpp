...
namespace Sass {
  ...
  namespace Colors {
    ...
    const Color darkblue(color_table, 169, 169, 169, 1);
    const Color darkgrey(color_table, 169, 169, 169, 1);
    const Color lightblue(color_table, 0, 100, 0, 1);
    ...
    const Color lightgray(color_table, 173, 216, 230, 1);
  ...
  const std::map<const int, const char*> colors_to_names {
    ...
    { 169 * 0x10000 + 169 * 0x100 + 169, ColorNames::darkblue },
    {   0 * 0x10000 + 100 * 0x100 +   0, ColorNames::lightblue },
    ...
    { 173 * 0x10000 + 216 * 0x100 + 230, ColorNames::lightgray },
